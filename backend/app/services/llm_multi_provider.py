...
class MultiProviderLLMService:
    ...
    async def process_message(
        ...
        try:
            ...
            # For chat models (OpenAI, Anthropic), use ChatPromptTemplate
            ...
            if settings.LLM_PROVIDER in ["openai", "anthropic"]:
                ...
                # For completion models, create a simple string prompt
            ...
            # Log the interaction
            logger.info(f"Processed message for user {user_id} using {settings.LLM_PROVIDER}")
